...
# ── CORS Middleware ─────────────────────────────────────────────────────────
# Configured specifically to allow the Flutter app, Swagger UI, and localhost
# during development — avoids generic wildcard (*) for origins for security.
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost",
        "http://localhost:8080",
        "http://localhost:59167",
        "http://127.0.0.1",
        "https://linear-regression-model-y4xx.onrender.com",
    ],
